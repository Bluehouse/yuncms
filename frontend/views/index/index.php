...
<head>
    ...
    <link href="assets/v1.0/css/hmstyle.css" rel="stylesheet" type="text/css"/>
    <link href="assets/v1.0/css/skin.css" rel="stylesheet" type="text/css"/>
...
<div class="banner">
    ...
    <div class="am-slider am-slider-default scoll" data-am-flexslider id="demo-slider-0">
        <ul class="am-slides">
            <li class="banner1"><a href="introduction.html"><img src="assets/v1.0/images/ad1.jpg"/></a></li>
            <li class="banner2"><a><img src="assets/v1.0/images/ad2.jpg"/></a></li>
            <li class="banner3"><a><img src="assets/v1.0/images/ad3.jpg"/></a></li>
            <li class="banner4"><a><img src="assets/v1.0/images/ad4.jpg"/></a></li>
...
<div class="shopNav">
    <div class="slideall">
                        ...
                        <ul class="category-list" id="js_climit_li">
                            <li class="appliance js_toggle relative first">
                                <div class="category-info">
                                    <h3 class="category-name b-category-name"><i><img src="assets/v1.0/images/cake.png"></i><a
                            ...
                            <li class="appliance js_toggle relative">
                                <div class="category-info">
                                    <h3 class="category-name b-category-name"><i><img src="assets/v1.0/images/cookies.png"></i><a
                            ...
                            <li class="appliance js_toggle relative">
                                <div class="category-info">
                                    <h3 class="category-name b-category-name"><i><img src="assets/v1.0/images/meat.png"></i><a
                            ...
                            <li class="appliance js_toggle relative">
                                <div class="category-info">
                                    <h3 class="category-name b-category-name"><i><img src="assets/v1.0/images/bamboo.png"></i><a
                            ...
                            <li class="appliance js_toggle relative">
                                <div class="category-info">
                                    <h3 class="category-name b-category-name"><i><img src="assets/v1.0/images/nut.png"></i><a
                            ...
                            <li class="appliance js_toggle relative">
                                <div class="category-info">
                                    <h3 class="category-name b-category-name"><i><img src="assets/v1.0/images/candy.png"></i><a
                            ...
                            <li class="appliance js_toggle relative">
                                <div class="category-info">
                                    <h3 class="category-name b-category-name"><i><img src="assets/v1.0/images/chocolate.png"></i><a
                            ...
                            <li class="appliance js_toggle relative">
                                <div class="category-info">
                                    <h3 class="category-name b-category-name"><i><img src="assets/v1.0/images/fish.png"></i><a
                            ...
                            <li class="appliance js_toggle relative">
                                <div class="category-info">
                                    <h3 class="category-name b-category-name"><i><img src="assets/v1.0/images/tea.png"></i><a
                            ...
                            <li class="appliance js_toggle relative last">
                                <div class="category-info">
                                    <h3 class="category-name b-category-name"><i><img src="assets/v1.0/images/package.png"></i><a
        ...
        <div class="am-g am-g-fixed smallnav">
            <div class="am-u-sm-3">
                <a href="sort.html"><img src="assets/v1.0/images/navsmall.jpg"/>
                    <div class="title">商品分类</div>
                </a>
            </div>
            <div class="am-u-sm-3">
                <a href="#"><img src="assets/v1.0/images/huismall.jpg"/>
                    <div class="title">大聚惠</div>
                </a>
            </div>
            <div class="am-u-sm-3">
                <a href="#"><img src="assets/v1.0/images/mansmall.jpg"/>
                    <div class="title">个人中心</div>
                </a>
            </div>
            <div class="am-u-sm-3">
                <a href="#"><img src="assets/v1.0/images/moneysmall.jpg"/>
            ...
            <div class="demo">
                ...
                <ul>
                    <li class="title-first"><a target="_blank" href="#">
                            <img src="assets/v1.0/images/TJ2.jpg"></img>
                            <span>[特惠]</span>商城爆品1分秒
                        </a></li>
                    <li class="title-first"><a target="_blank" href="#">
                            <span>[公告]</span>商城与广州市签署战略合作协议
                            <img src="assets/v1.0/images/TJ.jpg"></img>
                    ...
                    <div class="mod-vip">
                        <div class="m-baseinfo">
                            <a href="../person/index.html">
                                <img src="assets/v1.0/images/getAvatar.do.jpg">
                            </a>
                            <em>
                ...
                <div class="advTip"><img src="assets/v1.0/images/advTip.jpg"/></div>
            </div>
        </div>
        <div class="clear"></div>
    </div>
...
<div class="shopMainbg">
    <div class="shopMain" id="shopmain">
        ...
        <div class="am-g am-g-fixed recommendation">
            ...
            ">
            <img src="assets/v1.0/images/2016.png "></img>
            <p>今日<br>推荐</p>
        </div>
        <div class="am-u-sm-4 am-u-lg-3 ">
            ...
            <div class="recommendationMain one">
                <a href="introduction.html"><img src="assets/v1.0/images/tj.png "></img></a>
            </div>
        </div>
        <div class="am-u-sm-4 am-u-lg-3 ">
            <div class="info ">
            ...
            <div class="recommendationMain two">
                <img src="assets/v1.0/images/tj1.png "></img>
            </div>
        </div>
        <div class="am-u-sm-4 am-u-lg-3 ">
            <div class="info ">
            ...
            <div class="recommendationMain three">
                <img src="assets/v1.0/images/tj2.png "></img>
            </div>
        </div>
        ...
        <div class="am-g am-g-fixed ">
            <div class="am-u-sm-3 ">
                ...
                <div class="activityMain ">
                    <img src="assets/v1.0/images/activity1.jpg "></img>
                </div>
                <div class="info ">
                    <h3>春节送礼优选</h3>
                </div>
            ...
            <div class="am-u-sm-3 ">
                ...
                <h4>特惠</h4>
                <div class="activityMain ">
                    <img src="assets/v1.0/images/activity2.jpg "></img>
                </div>
                <div class="info ">
                    <h3>春节送礼优选</h3>
                </div>
            ...
            <div class="am-u-sm-3 ">
                ...
                <h4>团购</h4>
                <div class="activityMain ">
                    <img src="assets/v1.0/images/activity3.jpg "></img>
                </div>
                <div class="info ">
                    <h3>春节送礼优选</h3>
                </div>
            ...
            <div class="am-u-sm-3 last ">
                ...
                <h4>超值</h4>
                <div class="activityMain ">
                    <img src="assets/v1.0/images/activity.jpg "></img>
                </div>
                <div class="info ">
                    <h3>春节送礼优选</h3>
                </div>
        ...
        <div class="am-g am-g-fixed floodFour">
            <div class="am-u-sm-5 am-u-md-4 text-one list ">
                ...
                <a href="# ">
                    ...
                    <img src="assets/v1.0/images/act1.png "/>
                </a>
            ...
            <div class="am-u-sm-7 am-u-md-4 text-two sug">
                ...
                <a href="# "><img src="assets/v1.0/images/2.jpg"/></a>
            </div>
            ...
            <div class="am-u-sm-7 am-u-md-4 text-two">
                ...
                <a href="# "><img src="assets/v1.0/images/1.jpg"/></a>
            </div>
            ...
            <div class="am-u-sm-3 am-u-md-2 text-three big">
                ...
                <a href="# "><img src="assets/v1.0/images/5.jpg"/></a>
            </div>
            ...
            <div class="am-u-sm-3 am-u-md-2 text-three sug">
                ...
                <a href="# "><img src="assets/v1.0/images/3.jpg"/></a>
            </div>
            ...
            <div class="am-u-sm-3 am-u-md-2 text-three ">
                ...
                <a href="# "><img src="assets/v1.0/images/4.jpg"/></a>
            </div>
    ...
    <div id="f2">
        ...
        <div class="am-g am-g-fixed floodThree ">
            ...
            <div class="am-u-sm-4 text-four">
                <a href="# ">
                    <img src="assets/v1.0/images/6.jpg"/>
                    <div class="outer-con ">
                        <div class="title ">
                            雪之恋和风大福
                        </div>
            ...
            <div class="am-u-sm-4 text-four sug">
                <a href="# ">
                    <img src="assets/v1.0/images/7.jpg"/>
                    <div class="outer-con ">
                        <div class="title ">
                            雪之恋和风大福
                        </div>
            ...
            <div class="am-u-sm-6 am-u-md-3 text-five big ">
                <a href="# ">
                    <img src="assets/v1.0/images/10.jpg"/>
                    <div class="outer-con ">
                        <div class="title ">
                            雪之恋和风大福
                        </div>
            ...
            <div class="am-u-sm-6 am-u-md-3 text-five ">
                <a href="# ">
                    <img src="assets/v1.0/images/8.jpg"/>
                    <div class="outer-con ">
                        <div class="title ">
                            雪之恋和风大福
                        </div>
            ...
            <div class="am-u-sm-6 am-u-md-3 text-five sug">
                <a href="# ">
                    <img src="assets/v1.0/images/9.jpg"/>
                    <div class="outer-con ">
                        <div class="title ">
                            雪之恋和风大福
                        </div>
    ...
    <div id="sidebar">
        <div id="wrap">
            <div id="prof" class="item ">
                ...
                <div class="ibar_login_box status_login ">
                    <div class="avatar_box ">
                        <p class="avatar_imgbox "><img src="assets/v1.0/images/no-img_mid_.jpg "/></p>
                        <ul class="user_info ">
                            <li>用户名sl1903</li>
                            <li>级&nbsp;别普通会员</li>
                        </ul>
            ...
            <div id="brand " class="item ">
                <a href="#">
                    <span class="wdsc "><img src="assets/v1.0/images/wdsc.png "/></span>
                </a>
                <div class="mp_tooltip ">
                    我的收藏
                    <i class="icon_arrow_right_black "></i>
            ...
            <div id="broadcast " class="item ">
                <a href="# ">
                    <span class="chongzhi "><img src="assets/v1.0/images/chongzhi.png "/></span>
                </a>
                <div class="mp_tooltip ">
                    我要充值
                    <i class="icon_arrow_right_black "></i>
            ...
            <div class="quick_toggle ">
                ...
                <li class="qtitem ">
                    ...
                    <div class="mp_qrcode " style="display:none; "><img src="assets/v1.0/images/weixin_code_145.png "/><i
