...
<head>
    ...
    <link href="assets/v1.0/css/personal.css" rel="stylesheet" type="text/css">
    <link href="assets/v1.0/css/orstyle.css" rel="stylesheet" type="text/css">
    <script src="assets/v1.0/AmazeUI-2.4.2/assets/js/jquery.min.js"></script>
    <script src="assets/v1.0/AmazeUI-2.4.2/assets/js/amazeui.js"></script>
</head>
                                            ...
                                            <div class="order-left">
                                                ...
                                                <ul class="item-list">
                                                    <li class="td td-item">
                                                        <div class="item-pic">
                                                            <a href="#" class="J_MakePoint">
                                                                <img src="assets/v1.0/images/62988.jpg_80x80.jpg"
                                                                     class="itempic J_ItemImg">
                                                            </a>
                                                        </div>
                                                        <div class="item-info">
