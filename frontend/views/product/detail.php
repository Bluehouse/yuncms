...
<head>
    ...
    <link type="text/css" href="assets/v1.0/css/optstyle.css" rel="stylesheet"/>
    <link type="text/css" href="assets/v1.0/css/style.css" rel="stylesheet"/>

    <script type="text/javascript" src="assets/v1.0/basic/js/jquery-1.7.min.js"></script>
    <script type="text/javascript" src="assets/v1.0/basic/js/quick_links.js"></script>

    <script type="text/javascript" src="assets/v1.0/AmazeUI-2.4.2/assets/js/amazeui.js"></script>
...
<div class="listMain">
    ...
    <div class="scoll">
        <section class="slider">
            <div class="flexslider">
                <ul class="slides">
                    <li>
                        <img src="assets/v1.0/images/01.jpg" title="pic"/>
                    </li>
                    <li>
                        <img src="assets/v1.0/images/02.jpg"/>
                    </li>
                    <li>
                        <img src="assets/v1.0/images/03.jpg"/>
                    </li>
                </ul>
            </div>
        </section>
    ...
    <div class="item-inform">
        <div class="clearfixLeft" id="clearcontent">
            ...
            <div class="box">
                ...
                <div class="tb-booth tb-pic tb-s310">
                    <a href="assets/v1.0/images/01.jpg"><img src="assets/v1.0/images/01_mid.jpg" alt="细节展示放大镜特效" rel="assets/v1.0/images/01.jpg"
                                                    class="jqzoom"/></a>
                </div>
                <ul class="tb-thumb" id="thumblist">
                    <li class="tb-selected">
                        <div class="tb-pic tb-s40">
                            <a href="#"><img src="assets/v1.0/images/01_small.jpg" mid="assets/v1.0/images/01_mid.jpg"
                                             big="assets/v1.0/images/01.jpg"></a>
                        </div>
                    </li>
                    <li>
                        <div class="tb-pic tb-s40">
                            <a href="#"><img src="assets/v1.0/images/02_small.jpg" mid="assets/v1.0/images/02_mid.jpg"
                                             big="assets/v1.0/images/02.jpg"></a>
                        </div>
                    </li>
                    <li>
                        <div class="tb-pic tb-s40">
                            <a href="#"><img src="assets/v1.0/images/03_small.jpg" mid="assets/v1.0/images/03_mid.jpg"
                                             big="assets/v1.0/images/03.jpg"></a>
                        </div>
                    </li>
                </ul>
            </div>
        ...
        <div class="theme-signin-right">
            <div class="img-info">
                <img src="assets/v1.0/images/songzi.jpg"/>
            </div>
            <div class="text-info">
...
<div class="match">
    ...
    <div class="match-comment">
        <ul class="like_list">
            <li>
                <div class="s_picBox">
                    <a class="s_pic" href="#"><img src="assets/v1.0/images/cp.jpg"></a>
                </div>
            ...
            <li>
                <div class="s_picBox">
                    <a class="s_pic" href="#"><img src="assets/v1.0/images/cp2.jpg"></a>
                </div>
    ...
    <div class="browse">
        <div class="mc">
            <ul>
                ...
                <li class="first">
                    <div class="p-img">
                        <a href="#"> <img class="" src="assets/v1.0/images/browse1.jpg"> </a>
                    </div>
                ...
                <div class="am-tab-panel am-fade am-in am-active">
                    ...
                    <div class="details">
                        ...
                        <div class="twlistNews">
                            <img src="assets/v1.0/images/tw1.jpg"/>
                            <img src="assets/v1.0/images/tw2.jpg"/>
                            <img src="assets/v1.0/images/tw3.jpg"/>
                            <img src="assets/v1.0/images/tw4.jpg"/>
                            <img src="assets/v1.0/images/tw5.jpg"/>
                            <img src="assets/v1.0/images/tw6.jpg"/>
                            <img src="assets/v1.0/images/tw7.jpg"/>
                        </div>
                    </div>
                    <div class="clear"></div>
                ...
                <div class="am-tab-panel am-fade">
                    ...
                    <ul class="am-comments-list am-comments-list-flip">
                        <li class="am-comment">
                            <!-- 评论容器 -->
                            <a href="">
                                <img class="am-comment-avatar" src="assets/v1.0/images/hwbn40x40.jpg"/>
                                <!-- 评论者头像 -->
                            </a>
                        ...
                        <ul class="am-avg-sm-2 am-avg-md-3 am-avg-lg-4 boxes">
                            <li>
                                <div class="i-pic limit">
                                    <img src="assets/v1.0/images/imgsearch1.jpg"/>
