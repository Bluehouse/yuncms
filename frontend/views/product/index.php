...
<head>
    ...
    <link href="assets/v1.0/css/seastyle.css" rel="stylesheet" type="text/css"/>
    <script type="text/javascript" src="assets/v1.0//basic/js/jquery-1.7.min.js"></script>
    <script type="text/javascript" src="assets/v1.0//js/script.js"></script>
</head>
                ...
                <div class="search-side">
                    ...
                    <li>
                        <div class="i-pic check">
                            <img src="assets/v1.0/images/cp.jpg"/>
                    ...
                    <li>
                        <div class="i-pic check">
                            <img src="assets/v1.0/images/cp2.jpg"/>
