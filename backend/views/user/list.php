...
<div class="container-fluid p-y-md">
    ...
    <div class="card">
        ...
        <div class="card-block">
            <a href="<?php echo Url::to(['member/add']); ?>"><i class="fa fa-plus btn btn-app-green-outline">添加用户</i></a>
            <a href="<?php echo Url::to(['member/delAll']); ?>"><i class="ion-android-delete btn btn-app-blue-outline">删除</i></a>
                    ...
                    <div class="dataTables_paginate paging_simple_numbers">
                        <ul class="pagination pagination-sm">
                            <?php echo yii\widgets\LinkPager::widget(['pagination' => $pager,
                                'prevPageLabel' => '<i class="ion-chevron-left"></i>',
                                'nextPageLabel' => '<i class="ion-chevron-right"></i>']);
                            ?>
                        </ul>
                    </div>
                </div>
