        ...
        <div class="col-lg-11">
            <div class="card">
                ...
                <div class="card-block">
                    <a href="<?php echo yii\helpers\Url::to(['rbac/roles']); ?>"><i class="fa fa-share btn btn-app-green-outline">返回列表</i></a>
...
<div class="col-md-7">{input}{error}</div>'
                    ...
                    <div class="form-group">
                        <?php echo Html::label('规则类名称', null) . Html::textInput('class_name', '', ['class' => 'col-md-7']); ?>
                    </div>
