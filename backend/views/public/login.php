                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-md-offset-4">
                            <div class="card">
                                <h3 class="card-header h4">欢迎登录</h3>
                                <div class="card-block">
                                    <?php $form = ActiveForm::begin([
                                        ...
                                        <div class="form-group">
                                            <?php echo $form->field($model, 'adminpass')->passwordInput(['class' => 'form-control', 'placeholder' => '密码'])?>
                                        </div>
                                        <div class="form-group">
                                            <?php echo $form->field($model, 'rememberMe')->checkbox([
                                                'id' => 'remember-me',
                                                'template' => '<label for="remember-me" class="css-input switch switch-sm switch-app">{input}<span></span>记住我</label>'
                                                ]);
                                            ?>
                                            <a href="<?php echo Url::to(['public/seekpass']); ?>">忘记密码？</a>
                                        </div>

                                        <?php echo Html::submitButton("登录", ["class" => "btn btn-app btn-block"]); ?>
                                        <?php ActiveForm::end();?>
                                </div>
                            </div>
                        </div>
