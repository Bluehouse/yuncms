                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-md-offset-4">
                            <div class="card">
                                <h3 class="card-header h4">修改密码</h3>
                                <p class="text-green">
                                ...
                                <div class="card-block">
                                    ...
                                    <div class="form-group">
                                        <?php echo $form->field($model, 'adminrepass')->passwordInput(['class' => 'form-control', 'placeholder' => '确认密码']); ?>
                                    </div>
                                    <?php echo Html::submitButton("提交", ["class" => "btn btn-app btn-block"]); ?><?php echo Html::resetButton("重置", ["class" => "btn btn-app-orange btn-block"]); ?>
                                    <?php ActiveForm::end();?>
                                </div>
                            </div>
                        </div>
